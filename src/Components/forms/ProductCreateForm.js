...
const ProductCreateForm = ({ values, handleChange, handleChangeInput, handleSubmit,
    handleCategoryChange, showSub, subOptions, setValues }) => {
    const {
        title,
        description,
        price,
                ...
                <div style={{ display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column' }}>
                        ...
                        >
                            <Select.Option value="">Please select</Select.Option>
                            {brands.map((b) => (
                                <Select.Option key={b._id} value={b}>
                                    {b}
                                </Select.Option>
                            ))}
                        </Select>
